        ...
        >
            ...
            >
                ...
                {!isCompleted && (
                    <div
                        {...getRootProps()}
                        className="h-20 max-w-20 w-20 border-2 border-[color:var(--color-main)] rounded-lg flex
                        items-center justify-center cursor-pointer hover:bg-[color:var(--color-main-light)] transition-all duration-200"
                        role="button"
                        tabIndex={0}
                    ...
                    >
                        ...
                        />
                        <IconPlus aria-hidden="true" className="text-[color:var(--color-main)]" stroke={2.5} />
